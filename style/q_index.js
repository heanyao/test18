      ...
      if (data.code === 200) {
        ...
        for (let j = 0; j < d.length; j++) {
          ...
          htmlText += '</div>\
              ...
              j].ding_sum + '</span><img src="/static/index/images/ico_dianzai.png" data-ding-type="1" onclick="ding2(this,' + d[j].id +
            ')"></span>\
